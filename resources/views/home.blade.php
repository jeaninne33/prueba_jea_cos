                            ...
                            <ul class="metismenu" id="menu">
                                <li class="active">
                                    <a href="javascript:void(0)" aria-expanded="true"><i
                                            class="ti-dashboard"></i><span>Bienvenido Usuario</span></a>
                                    <ul class="collapse">
                                        <li ><a href="{{route('emails.index')}}">Ver Listado de Emails</a></li>
                                        <li><a href="{{route('emails.create')}}">Agregar Emails</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Bienvenido Usuario <b>.:::{{Auth::user()->name}}:::.</b></h4>
